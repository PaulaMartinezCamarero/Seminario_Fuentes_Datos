poblacion_cyl <- data.frame(
  ...
  Porc_pob_extranj_sobre_pob_total = c(8.05, 9.27, 5.21, 5.43, 5.68, 12.88, 11.57, 6.39, 4.55, 7.04),
  Num_munic_pob_extranj_mas_3_por_ciento = c(106, 220, 102, 88, 130, 167, 83, 150, 110, 1156)
)
