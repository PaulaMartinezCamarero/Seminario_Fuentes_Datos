...
ictus_por_provincia(Provincias)
```
...
df$prov <-c("Ávila","Burgos","León","Palencia","Salamanca","Segovia","Soria","Valladolid","Zamora")
...
reg_mul <- lm(num_ictus.numero_ictus ~ pob.provincia + centros.n, data = datos)
summary(reg_mul)
