...
```{r}
source("INPUT/functions/media_factores_aire.R")
...
media_NO_por_provincia <- calidad_aire %>%
  ...
  summarise(media_NO = mean(`NO (ug/m3)`, na.rm = TRUE),
            media_03 =mean(`O3 (ug/m3)`, na.rm = TRUE),
            media_PM25=mean(`PM25 (ug/m3)`, na.rm = TRUE))
