...
```{r}
library(readr)
calidad_aire <- read_csv("C:/Users/dresv/Desktop/seminario_fuentes/Seminario_Fuentes_Datos/data/calidad_aire.csv")
View(calidad_aire)
```
...
```{r}
library(readr)
sedentarismo <- read_delim("C:/Users/dresv/Desktop/seminario_fuentes/Seminario_Fuentes_Datos/data/sedentarismo.csv", 
...
```{r}
library(readr)
exposicion_humo <- read_delim("C:/Users/dresv/Desktop/seminario_fuentes/Seminario_Fuentes_Datos/data/exposicion_humo.csv", 
    delim = ";", escape_double = FALSE, trim_ws = TRUE)
