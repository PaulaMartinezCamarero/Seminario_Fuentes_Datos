...
Debido a que esta tabla también es muy grande tampoco la mostramos con el paquete: library(DT).Debido a que esta tabla también es muy grande tampoco la mostramos con el paquete: library(DT).Debido a que esta tabla también es muy grande tampoco la mostramos con el paquete: library(DT).
...
```
Probablemente, al igual que nosotros antes de realizar este trabajo no sepáis lo que es la sustancia PM2,5, esta esun conjunto de partículas que se encuentran en suspension aerodinámica cuyo diámetro es inferior a 2,5 micras.
