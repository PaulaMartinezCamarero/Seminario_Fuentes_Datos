...
## Obtener el número de hombres y mujeres para ver si el sexo influye en la cantidad de ictus
...
Faceta para mostrar lo explicado anteriormente:
...
```{r}
tabla_predicciones <- data.frame(tabla_metricas, predicciones = predict(modelo_regresion))
