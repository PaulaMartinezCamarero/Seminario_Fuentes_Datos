...
tabla_con_columna_con_todos_gases %>%
  ggplot(aes(x=media_de_concentracion, y=media))+
  geom_point(aes(colour = factor(provincia)))+
  geom_smooth(method = "lm", aes(colour = factor(provincia)))+
...
tabla_con_columna_con_todos_gases%>%
  ...
  labs(x="Media de concentración", y="Provincias", colour="Sustancias", title = "Concentración de las distintas sustancias por provincia y año")
